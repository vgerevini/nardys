...
/// </summary>
public class DORelatorioOcorrencia
{
    #region Listar
    public static DataTable Listar(DateTime? pdatInicial, DateTime? pdatFinal)
    {
        ...
        SqlCommand objComando = new SqlCommand("SPE_L_RELATORIO_OCORRENCIA");
    ...
    public static DataTable TrataExcel(DataTable dt)
    {
        ...
        foreach (DataRow dr in dt.Rows)
        {
            ...
            drN["Descricao Status Usuario"] = dr["PC_Relatorio_Prospeccoes"].ToString();
