<%@ Page ClientIDMode="AutoID" Title="" Language="C#" MasterPageFile="~/Modulos/Modulos.master" AutoEventWireup="true" CodeFile="Listar.aspx.cs" Inherits="Manager_Modulos_Clientes_Listar" %>

<%@ Register Assembly="WebFoundations.ServerControls" Namespace="WebFoundations.ServerControls" TagPrefix="wfc" %>
<asp:Content ID="Content1" ContentPlaceHolderID="contentInterna" runat="Server">
    <div id="title">
        <h1>
            <asp:Label ID="lblTitulo" runat="server"><%=Resources.Textos.Modulo_Cliente_Titulo_Listagem %></asp:Label>
        </h1>
    </div>
    <br />
    <div class="filtros">
    ...
    <asp:DataGrid summary="Lista de Clientes" ID="grdDados" runat="server" AutoGenerateColumns="false" CssClass="listagem-Grid" AlternatingRowStyle-CssClass="par" Width="100%" AllowPaging="True"
        ...
        <Columns>
            ...
            <asp:BoundColumn DataField="Telefone" SortExpression="Telefone" HeaderText="Telefone" HeaderStyle-CssClass="tabelaHeader" ItemStyle-Width="20%" />
