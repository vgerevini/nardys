<%@ Page ClientIDMode="AutoID" Title="" Language="C#" MasterPageFile="~/Modulos/Modulos.master" AutoEventWireup="true" CodeFile="Listar.aspx.cs" Inherits="Manager_Modulos_Produtos_Listar" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentInterna" runat="Server">
    ...
    <div class="filtros">
        ...
        <div class="fields-edit">
            ...
            <label>
                <span>
                    <asp:Label ID="lblCategoria" runat="server" title="Categoria"><%=Resources.Textos.Modulo_Produto_Categoria %></asp:Label>
                </span>
    ...
    <asp:DataGrid summary="Lista de Produtos" ID="grdDados" runat="server" AutoGenerateColumns="false" CssClass="listagem-Grid" AlternatingRowStyle-CssClass="par" Width="100%" AllowPaging="True"
